...
#message = '{"jsonrpc":"2.0","id":0,"method":"initialize","params":{"processId":1,"rootPath":"/home/kristian/docker-node-alpine-intelephense","rootUri":"file:///home/kristian/docker-node-alpine-intelephense","capabilities":{ } } }'
# message = '{"jsonrpc":"2.0","id":0,"method":"initialize","params":{"processId":1,"rootPath":"/home","rootUri":"file:///home","capabilities":{ } } }'
# sendLspMsg(sockClient,message)

# sendJsonRpc(sock=sockClient, idparam=0, method="initialize", params={
#     "processId":1,
#     "clientInfo":{
#         "name":"kristian custom client",
#         "version":"0.0.1",
#     },
...
#         "clearCache": False, # TODO: cek ini buat apa?
#     }
# })
...
# message = sockClient.recv(bufferSize).decode()

# message = recvLspMsg(sockClient)
